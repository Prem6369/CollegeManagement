...
@Component({
  selector: 'app-admin-editpc',
  templateUrl: './admin-editpc.component.html',
  styleUrl: './admin-editpc.component.scss'
})
export class AdminEditpcComponent implements OnInit {
  id!: number;
